...
ActiveRecord::Schema.define(version: 20151112205202) do
  ...
  add_index "followings", ["user_id", "followed_id"], name: "index_followings_on_user_id_and_followed_id", unique: true, using: :btree
